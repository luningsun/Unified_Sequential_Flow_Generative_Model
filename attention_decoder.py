...
class AttentionDecoder(nn.Module):
    def __init__(self, n_embd, embd_pdrop,n_ctx,n_layer,layer_norm_epsilon,attn_pdrop, resid_pdrop,n_head, activation_function, position ):
        super().__init__()
        print('Use Xu Model')
